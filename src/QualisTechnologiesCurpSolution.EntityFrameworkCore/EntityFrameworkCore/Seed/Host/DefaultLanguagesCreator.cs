...
namespace QualisTechnologiesCurpSolution.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly QualisTechnologiesCurpSolutionDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = QualisTechnologiesCurpSolutionConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(QualisTechnologiesCurpSolutionDbContext context)
        {
            _context = context;
        }
